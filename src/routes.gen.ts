...
import { Route as rootRoute } from './../apps/dashboard/src/routes/__root'
import { Route as IndexImport } from './../apps/dashboard/src/routes/index'
import { Route as authLayoutImport } from './../apps/dashboard/src/routes/(auth)/_layout'
import { Route as appLayoutImport } from './../apps/dashboard/src/routes/(app)/_layout'
import { Route as authLayoutLoginImport } from './../apps/dashboard/src/routes/(auth)/_layout.login'
import { Route as appLayoutDashboardImport } from './../apps/dashboard/src/routes/(app)/_layout.dashboard'
